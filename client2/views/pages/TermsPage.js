...
export default function TermsPage() {
  return (
    <div id="terms" className="page">
      <h1>Sagefy Privacy Policy & Terms of Service</h1>

      <h2>General Terms</h2>

      <p>
        If you have questions about these terms, contact Sagefy at{' '}
        <a href="support@sagefy.org">support@sagefy.org</a>.
      </p>
      ...
      <p>
        Sagefy&quot;s software is licensed under the{' '}
      ...
      <p>
        ...
        if required by law, b) to defend Sagefy&quot;s rights and property, or
        c) to ensure personal safety or public safety.
      </p>

      <p>
        If Sagefy merges with or is acquired by another organization, data will
        be transferred to that organization.
      </p>
      ...
      <p>
        If you are under the age of thirteen, you must ask a parent or guardian
        before using Sagefy.
      </p>
      ...
      <p>
        Sagefy is not liable for any damages resulting from unauthorized use of
        your account.
      </p>
      ...
      <p>
        If you or Sagefy closes your account, your personal information will be
        removed, but your contributions will remain on the service.
      </p>
      ...
      <p>
        ...
        licensed under a{' '}
        <a href="http://creativecommons.org/">Creative Commons license</a> or
        similar license.
      </p>
      ...
      <p>
        Sagefy, and its content, does not offer professional, financial, legal,
        or medical advice.
      </p>
      ...
      <p>
        Sagefy may update and remove user-provided content, but Sagefy does not
        make any commitment to update or remove content.
      </p>
      ...
      <p>
        Notices and counter-notices must meet statutory requirements imposed by

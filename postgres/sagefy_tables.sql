...
CREATE TRIGGER update_topics_modified BEFORE UPDATE ON topics FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_posts_modified BEFORE UPDATE ON posts FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_notices_modified BEFORE UPDATE ON notices FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_follows_modified BEFORE UPDATE ON follows FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_units_modified BEFORE UPDATE ON units FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_subjects_modified BEFORE UPDATE ON subjects FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_cards_modified BEFORE UPDATE ON cards FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_cards_parameters_modified BEFORE UPDATE ON cards_parameters FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_users_subjects_modified BEFORE UPDATE ON users_subjects FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_responses_modified BEFORE UPDATE ON responses FOR EACH ROW EXECUTE PROCEDURE update_modified_column();
...
CREATE TRIGGER update_suggests_modified BEFORE UPDATE ON suggests FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

CREATE TRIGGER update_suggests_followers_modified BEFORE UPDATE ON suggests_followers FOR EACH ROW EXECUTE PROCEDURE update_modified_column();

/*
Later: comments, bids, sponsors
suggests_comments - id, created, modified, suggest_id, user_id, body suggests_bids - id, created, modified, suggest_id, user_id, status, data[price, duration, scope, background]
suggests_sponsors - id, created, modified, bid_id, user_id, price, status, expires_at
*/

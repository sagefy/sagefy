...
export default function EditChoiceCardPage({
  hash,
  role,
  ...
  return (
    ...
    >
      ...
      <Advice returnUrl={`/choice-cards/${to58(cardId)}/edit`} role={role} />
    </Layout>
  )
}

EditChoiceCardPage.propTypes = {
...
EditChoiceCardPage.defaultProps = {
  role: 'sg_anonymous',
  body: {
    name: '',
  },

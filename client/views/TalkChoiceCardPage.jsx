  ...
  return (
    <Layout hash={hash} page="TalkChoiceCardPage" title="Talk" description="-">
      <header>
        <div className="my-c">
          <p>
            Choice Card Talk <Icon i="choice" />
            <Icon i="card" />
            <Icon i="talk" />
          </p>
          <h1>
            Talk: <a href={`/choice-cards/${to58(entityId)}`}>{entityName}</a>
          </h1>
        </div>
        <small>
          <ul className="ls-i ta-r">
            ...
            <li>
              <a href={`/choice-cards/${to58(entityId)}/history`}>
...
TalkChoiceCardPage.defaultProps = {
  gqlErrors: {},
  body: {},
  query: {},
  topics: [],

...
export default function UnscoredEmbedCardHistoryPage({
  hash,
  role,
  ...
  return (
    <Layout
      hash={hash}
      page="UnscoredEmbedCardHistoryPage"
...
UnscoredEmbedCardHistoryPage.propTypes = {
...
UnscoredEmbedCardHistoryPage.defaultProps = {
  role: 'sg_anonymous',
}

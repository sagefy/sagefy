...
export default function UnscoredEmbedCardEditPage({
  hash,
  role,
  ...
  return (
    <Layout
      hash={hash}
      page="UnscoredEmbedCardEditPage"
...
UnscoredEmbedCardEditPage.propTypes = {
...
UnscoredEmbedCardEditPage.defaultProps = {
  role: 'sg_anonymous',
  body: {
    name: '',
    data$url: '',

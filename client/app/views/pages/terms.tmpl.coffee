...
Sagefy uses third-party services, such as
networking, storage, hardware, software, and related technologies,
to provide service.
...
Sagefy does not claim property rights to user submitted content.

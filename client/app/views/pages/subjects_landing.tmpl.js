...
module.exports = (data) => {
    ...
    return div(
        ...
        section(
            ...
            h3('Who'),
            p(
                'This subject is for anyone who wants to learn the basic ideas of electronic music systems. We will focus on computer-based systems.'
            ),
            h3('Outcome'),
            p(
                "You will be able to explain the basic properties of sound and hearing in a digital system. You'll be able to describe the basic tools of creating and modifying sounds. You'll have an understanding of some of the systems we use to create and edit electronic music."
            ),
            p(
                'This subject does not teach how to use a particular piece of software. The ideas here will apply to any software of your choice. This subject does not detail: the artistic study of electronic music, the history of electronic music, or how western music theory applies to electronic music. These are important topics, but outside of the scope of this focused subject.'
            ),
            h3('Requirements'),
            p(
                'This subject does not require extra software. This subject focuses on the what and why, not how. The ideas apply to any electronic music software, such as Pure Data, Audacity, and Ardour. A background in western music theory is not required.'
            ),
            p(
                'A basic understanding of mathematical concepts, such as linear vs logarithmic scale, is helpful. Some physics knowledge is also helpful, but not necessary.'
            ),
            h3('Difficulty'),
        ...
        section(
            ...
            ul(
                ...
                li(
                    w(icon('next')),
                    ' Short, informational videos. Easy to understand.'
                ),
                li(
                    w(icon('learn')),
                    ' Lots of practice questions to help you master the content.'
                ),
                li(
                    w(icon('settings')),
                    ' Sagefy adapts practice questions based on your responses.'
                ),
            ...
            ul(
                li(
                    ...
                    ul(
                        ...
                        li(
                            strong('Hearing Curves'),
                            ': Describe how hearing varies with frequency and amplitude.'
                        ),
                        li(
                            strong('Digital Representation'),
                            ': Describe how we represent sound digitally, including bit depth and sample rate.'
                        ),
                        li(
                            strong('Analog to Digital'),
                            ': Describe how we convert analog sound into digital sound. (Recording, Nyquist)'
                        ),
                        li(
                            strong('Complex Waves'),
                ...
                li(
                    ...
                    ul(
                        ...
                        li(
                            strong('Additive Synthesis'),
                            ': Describe how multiple waves produce a single sound.'
                        ),
                        li(
                            strong('Subtractive Synthesis'),
                ...
                li(
                    ...
                    ul(
                        ...
                        li(
                            strong('Modulation Effects'),
                            ': Describe modulation effects: tremolo, chorus, flange, phase, vibrato.'
                        ),
                        li(
                            strong('Amplitude Modifiers'),
                            ': Describe the basic characteristics of amplitude modifiers: gain, compressors, de-essers, expanders, multi-pressors.'
                        ),
                        li(
                            strong('Envelopes'),
                            ': Describe how amplitude changes over time (generators: envelopes).'
                        ),
                ...
                li(
                    ...
                    ul(
                        ...
                        li(
                            ...
                            small(' Coming soon!'),
                            ': Describe frequency modulation (FM) synthesis.'
                        ),
                        li(
                            strong('Granular Synthesis'),
                            small(' Coming soon!'),
                            ': Describe granular synthesis.'
                        ),
                        li(
                            strong('Formant Synthesis'),
                            small(' Coming soon!'),
                            ': Describe formant synthesis.'
                        ),
                        li(
                            strong('Physical Modeling'),
                            small(' Coming soon!'),
                            ': Describe physical modeling.'
                        ),
                        li(
                            strong('Convolution'),
                            small(' Coming soon!'),
        ...
        section(
            ...
            p(
                "I am Kevin Heis, the founder of Sagefy. I'm interested in real-time, algorithmic electronic music for performance and installation. I hold a Master's in Intermedia Music Technology from the University of Oregon. But more important, I love learning. I love to support others' learning goals too!"
            ),
            cta
        )
